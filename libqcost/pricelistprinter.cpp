...
public:
    PriceListPrinterPrivate(PriceList * b, PriceFieldModel * pfm):
        priceList(b),
        priceFieldModel(pfm){
    }
...
PriceListPrinter::PriceListPrinter( PriceList * b, PriceFieldModel * pfm ):
    m_d( new PriceListPrinterPrivate(b, pfm) ) {
}
